        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 min-h-[350px] max-h-[450px] overflow-y-auto">
                ...
                qaExamples.slice(0, currentQA + 1).map((qa, i) => (
                  <div key={i} className="space-y-3 animate-in slide-in-from-bottom-4">
                    ...
                    <div className="flex justify-start">
                      <div className="max-w-[85%] p-4 rounded-2xl bg-violet-500/10 border border-violet-500/20 backdrop-blur-sm">
              ...
              {isTyping && (
                <div className="flex justify-start">
                  <div className="p-4 rounded-2xl bg-violet-500/10 border border-violet-500/20 backdrop-blur-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="relative h-[400px] rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm p-8 overflow-hidden">
              {/* Connection Lines */}
                  ...
                  <div
                    ...
                    className={`absolute w-16 h-16 rounded-full flex items-center justify-center backdrop-blur-sm transition-all duration-500 ${
                      isActive
                        ...
                        : "bg-white/10 border border-white/20 hover:bg-violet-500/20 hover:border-violet-500/40 hover:scale-105"
                    }`}
                    style={{
                      top: `calc(50% + ${y}px)`,
                      left: `calc(50% + ${x}px)`,
