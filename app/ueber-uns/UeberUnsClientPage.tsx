...
export default function UeberUnsClientPage() {
            ...
            <div className="flex items-start gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-white/80 leading-relaxed">
                  ...
                  die spezifischen Bedürfnisse unserer Kunden zugeschnitten.
                </p>
              </div>
            </div>
          </section>
              ...
              <div>
                ...
                <ul className="space-y-3 text-white/80">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-violet-400 mt-1">•</span>
                    <span>
                      <strong className="text-white">Transparenz:</strong> Offene Kommunikation und klare Prozesse sind
                      uns wichtig
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
