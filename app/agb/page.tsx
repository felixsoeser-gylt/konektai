    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 md:p-12 space-y-8">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-8">Allgemeine Geschäftsbedingungen (AGB)</h1>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">2. Vertragsabschluss</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">3. Leistungen von KonektAI</h2>
            <div className="text-white/80 space-y-2">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">4. Preise und Zahlungsbedingungen</h2>
            <div className="text-white/80 space-y-2">
              <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">5. Mitwirkungspflichten des Kunden</h2>
            <div className="text-white/80 space-y-2">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">6. Urheberrechte und Nutzungsrechte</h2>
            <p className="text-white/80">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">7. Vertraulichkeit</h2>
            <p className="text-white/80">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">8. Haftung und Gewährleistung</h2>
            <div className="text-white/80 space-y-2">
              <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">9. Kündigung</h2>
            <p className="text-white/80">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-white">10. Schlussbestimmungen</h2>
            <div className="text-white/80 space-y-2">
